...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Hello = channel.unary_unary(
                '/calculator.Calculator/Hello',
                request_serializer=calculator__pb2.HelloRequest.SerializeToString,
                response_deserializer=calculator__pb2.HelloResponse.FromString,
                _registered_method=True)
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Hello': grpc.unary_unary_rpc_method_handler(
                    servicer.Hello,
                    request_deserializer=calculator__pb2.HelloRequest.FromString,
                    response_serializer=calculator__pb2.HelloResponse.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def Hello(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/calculator.Calculator/Hello',
            calculator__pb2.HelloRequest.SerializeToString,
            calculator__pb2.HelloResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
